...
- Make sure to create a package named "Drinks".
-	Ensure the main class is "Drinks.java" and subclasses are (MenuOfBeverages, ColdCoffee, MilkShake, etc.) are inside the drinks package.
-	Press F6 to run the file or right click then find run file.
-	Choose "1" for the Drinks App (Console version).
  
Option 2: Using GUI
-	Run the same file in Option 1.
-	Choose "2" for the GUI version.
-	The DrinksFrame will appear on the screen, allowing you to interact with the visual menu.
